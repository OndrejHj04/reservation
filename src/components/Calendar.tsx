      ...
      <div className="max-w-2xl mx-auto p-1">
        <div className=" p-2 shadow-2xl border rounded-3xl">
          <div className="hidden sm:block">
            <DaysDesktop weekDay={weekDay} getDaysInMonth={getDaysInMonth} year={year} state={state} />
          </div>

          <div className="sm:hidden block">
            <DaysMobile weekDay={weekDay} getDaysInMonth={getDaysInMonth} year={year} state={state}/>
          </div>
        </div>
      </div>
    </>
